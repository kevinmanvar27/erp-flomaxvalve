    ...
    <div class="content-wrapper">
        <section class="content">
            ...
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form method="GET" action="{{ route('rejection.create') }}">
                        <div class="row mb-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control select2" style="width: 100%;" id="type" name="type">
                                    ...
                                    <option value="client" {{ request('type') == 'client' ? 'selected' : '' }}>By Client</option>
                                    <option value="own" {{ request('type') == 'own' ? 'selected' : '' }}>By Own</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label for="type" class="form-label">Rejection</label>
                                <select class="form-control select2" style="width: 100%;" id="rejection " name="rejection">
                                    <option value="">Select Rejection</option>
                                    <option value="client" {{ request('rejection') == 'Internal' ? 'selected' : '' }}>Internal </option>
                                    <option value="own" {{ request('rejection') == 'own' ? 'selected' : '' }}>Customer </option>
                                </select>
                            </div>
                            <div class="col-md-3">
                ...
                <form method="POST" action="{{ route('rejection.store') }}">
                    @csrf
                    <div class="card-body">
