    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Total Sales Report</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-6">
                        <div class="small-box bg-danger">
                            <div class="inner">
                                <h3>₹<span id="total_pending">0.00</span></h3>
                                <p>Pending</p>
                            </div>
                            <div class="icon">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-table"></i> Sales Details</h3>
                            ...
                            <div class="card-body">
                                <table id="total-sales-table" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>SL No.</th>
                                            <th>Invoice Date</th>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                var table = $('#total-sales-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                        url: '{{ route('sales.totalReport.data') }}',
                        data: function(d) {
                ...
                function updateSummary() {
                    $.ajax({
                        url: '{{ route('sales.totalReport.summary') }}',
                        data: {
                ...
                $('#exportExcel').on('click', function() {
                    ...
                    window.location.href = '{{ route('sales.totalReport.export') }}?' + params;
                });
