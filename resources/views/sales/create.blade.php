                            ...
                            <div class="col-md-5">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control" id="courier_charge_before_gst" name="courier_charge_before_gst" value="0" /></td>
                                    </tr>
                                    <tr>
                                        <td>P & F Charge</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control" id="courier_charge_after_gst" name="courier_charge_after_gst" value="0" /></td>
                                    </tr>
                                    <tr>
                                        <td>Round Off</td>
